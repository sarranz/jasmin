...
val pp_pprog : debug:bool -> Wsize.wsize -> Wsize.wsize -> ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) pprog -> unit
...
val pp_instr : debug:bool ->
               Wsize.wsize ->
               Wsize.wsize ->
               ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) instr -> unit

val pp_stmt  : debug:bool ->
               Wsize.wsize ->
               Wsize.wsize ->
               ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) stmt  -> unit
...
val pp_fun :
             ...
             (('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.sopn) Utils.pp ->
             var Utils.pp ->
             (('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) func) Utils.pp

val pp_ifunc : debug:bool -> (Location.i_loc * 'info) Utils.pp ->
               Wsize.wsize ->
               Wsize.wsize ->
               ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) func -> unit
...
val pp_iprog : debug:bool -> (Location.i_loc * 'info) Utils.pp ->
               ...
               Wsize.wsize ->
               ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) prog -> unit
...
val pp_sprog : debug:bool ->
               ...
               Wsize.wsize ->
               ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('vinfo, 'iinfo, 'finfo, 'reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) sprog -> unit
