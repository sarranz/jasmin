...
(* TODO_ACC maybe all of these should also be extra ops, or make all the
...
Module ACCFopn_core.
  ...
  (* TODO_ACC double check preconditions, some do not apply if we fail
     explicitly *)
  #[local] Open Scope Z.

  Section CORE.

  Definition opn_args := (seq lexpr * acc_op * seq rexpr)%type.
