...
move=> ii env env' i' ii' /=; case h: is_Oslh => [slho|] /=.
- case: op h => //= _ [->].
  ...
  case heq : is_protect_ptr hargs => [sz|] /=; t_xrbindP.
  + move=> ???; subst xs' op' es'; move: hchk hexec.
    have -> : slho = SLHprotect_ptr sz by case: (slho) heq => //= _ [->].
    case: slho heq => //= _ _.
