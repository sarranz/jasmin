...
Definition wequiv_f_trans (p1 p3 : prog) fn dc1 dc2 p2 :=
  wequiv_f_trans
    (sem_F1 := sem_fun_full (dc := dc1))
    (sem_F2 := sem_fun_full (dc := dc2))
    (sem_F3 := sem_fun_full (dc := direct_c))
    _
    (p1 := p1) (p2 := p2) (p3 := p3)
...
Arguments wequiv_f_trans {_ _ _} _ _ _.
...
Proof.
  ...
  apply: wequiv_f_trans; first exact: it_wi2w_progP ok_paw.
  apply: wequiv_f_trans; first exact: (it_array_copy_fdP _ ok_pa0).
