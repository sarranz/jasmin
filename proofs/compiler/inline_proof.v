...
Proof.
  ...
  have /(esem_i_bodyP (sem_F := sem_fun_rec E)) h := assgn_tuple_Lvar
    ev [elaborate ii_with_location ii] AT_rename hdisje hes' htr' hws'.
  rewrite {}h /=.
  ...
  + apply/disjointP => z; rewrite vars_l_read_es => hz.
    ...
    rewrite /locals_p vrvs_recE read_cE write_c_recE vars_l_read_es.
    by move: hz; clear; SvD.fsetdec.
  have := assgn_tuple_Pvar _ [elaborate ii_with_location ii] AT_rename hdisjr hget' htr'.
