...
Context
  ...
  {wE : with_Error E E0}
  {rE0 : EventRels E0}
  (rE0_trans : EventRels_trans rE0)
.

Notation prog1 := (prog (pT := pT1)).
Notation prog2 := (prog (pT := pT2)).
Notation prog3 := (prog (pT := pT3)).
Notation wequiv_f12 := (wequiv_f (sem_F1 := sem_F1) (sem_F2 := sem_F2)).
Notation wequiv_f23 := (wequiv_f (sem_F1 := sem_F2) (sem_F2 := sem_F3)).
Notation wequiv_f13 := (wequiv_f (sem_F1 := sem_F1) (sem_F2 := sem_F3)).

Lemma wequiv_f_trans (p1 : prog1) (p2 : prog2) (p3 : prog3) ev1 ev2 ev3 fn1 fn2 fn3
  rpreF12 rpreF23 rpreF13 rpostF12 rpostF23 rpostF13 :
   ...
   wequiv_f12 p1 p2 ev1 ev2 rpreF12 fn1 fn2 rpostF12 ->
   wequiv_f23 p2 p3 ev2 ev3 rpreF23 fn2 fn3 rpostF23 ->
   wequiv_f13 p1 p3 ev1 ev3 rpreF13 fn1 fn3 rpostF13.
Proof.
